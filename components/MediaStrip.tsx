...
export default function MediaStrip({ folder, tall = false }: { folder: string; tall?: boolean }) {
  ...
  return (
    <div>
      {/* ⭐ Conteneur : images pleine taille, scrollbar visible */}
      <div className="moments-strip flex snap-x snap-mandatory items-center gap-6 overflow-x-auto pb-4 pl-5 pr-5">
        {items.map((m, i) => (
